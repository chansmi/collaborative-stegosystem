...
test_queries = ["Sample input text 1", "Sample input text 2"]
input_tensors = tokenizer(test_queries, return_tensors="pt", padding=True).input_ids

# Generate responses
generated_responses = model.generate(input_tensors, max_new_tokens=32)
